...
public class GitHubServlet extends HttpServlet
{
	 ...
	 */
	public static final String DEV_CLIENT_SECRET_FILE_PATH = "/WEB-INF/gitlab_dev_client_secret";


	/**
	 * Path component under war/ to locate iconfinder_key file.
	 */
	public static final String CLIENT_SECRET_FILE_PATH = "/WEB-INF/gitlab_client_secret";
			...
			HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (client != null && code != null)
		{
			...
			String url = "https://gitlab.com/login/oauth/access_token";
			URL obj = new URL(url);
